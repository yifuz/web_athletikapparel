...
function myathletik_technical_article_data() {
	return array(
		'flatlock-vs-overlock-technical-knitwear' => array(
			...
			'featured_image'   => 'production/articles/covers/flatlock-overlock-guide-cover.webp',
			'featured_small'   => 'production/articles/covers/flatlock-overlock-guide-cover-800.webp',
			'featured_alt'     => __( 'Editorial comparison of a low-profile seam and an overlocked edge on technical knit fabric', 'myathletik-child' ),
			'featured_width'   => 1200,
			'featured_height'  => 900,
