...
<section aria-labelledby="ma-seam-function-title">
	...
	<p>For an OEM/ODM project, send the garment drawing or tech pack, fabric specification, intended use, order quantity and required testing. Athletik Clothing can then review the seam map and develop samples around the confirmed construction requirements. See our <a href="<?php echo esc_url( home_url( '/sportswear-manufacturer/' ) ); ?>">sportswear manufacturing capabilities</a> or <a href="<?php echo esc_url( home_url( '/services/' ) ); ?>">OEM/ODM process</a> for related information, and the <a href="<?php echo esc_url( home_url( '/evaluate-technical-knitwear-oem/' ) ); ?>">technical knitwear OEM evaluation guide</a> when comparing candidate suppliers for the program.</p>
</section>
