...
$proof_media_base = get_stylesheet_directory_uri() . '/assets/images/production/equipment/fabric-production-floor';
...
<section class="ma-home-proof" aria-labelledby="ma-home-proof-title">
	<div class="ma-section-inner">
		...
		<div class="ma-home-proof__layout">
			<figure class="ma-context-image ma-home-proof__media">
				<img
					src="<?php echo esc_url( $proof_media_base . '-800.webp' ); ?>"
					srcset="<?php echo esc_attr( $proof_media_srcset ); ?>"
					sizes="(max-width: 63.99rem) calc(100vw - 3rem), 96rem"
					width="1536"
					height="1024"
					loading="lazy"
					decoding="async"
					alt="<?php esc_attr_e( 'Fabric production floor with yarn packages and knitting equipment', 'myathletik-child' ); ?>"
				>
			</figure>
