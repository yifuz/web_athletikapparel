...
$numbers = array(
	...
	array( 'value' => '3', 'unit' => __( 'continents', 'myathletik-child' ), 'label' => __( 'Brands served', 'myathletik-child' ), 'note' => __( 'North America, Europe, and Asia-Pacific.', 'myathletik-child' ) ),
);
?>
