...
$numbers = array(
	...
	array( 'value' => '~100', 'unit' => __( 'sewing workers', 'myathletik-child' ), 'label' => __( 'Technical sewing team', 'myathletik-child' ), 'note' => __( 'Production support for FLATLOCK, ACTIVESEAM, OVERLOCK, elastic joining, and general garment assembly.', 'myathletik-child' ) ),
);
?>
