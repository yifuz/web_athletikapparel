...
/**
 * Invalidate the Rank Math page and index Sitemap caches once per managed
 * Sitemap release.
 *
...
add_action( 'init', 'myathletik_invalidate_rank_math_sitemap_cache_release', 99 );
