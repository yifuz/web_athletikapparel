...
| [`change-cards/`](change-cards/) | SEO-IMP-024/035/036/037/038、SEO-V2-007/008/015、PCD-001 | 单一变量、基线、Crawl 和最终决策；V2-007 网站端验收通过但 LinkedIn 实际取图仍失败，当前 `platform-failed / diagnosis-monitoring`；V2-008 已完成生产验收并 `fixed / keep`；V2-015 Day 0 生产验收完成，当前 `fixed / measuring`；PCD-001 的首页询盘布局与本地 Form 3 已获所有者批准，等待主题文件部署及生产后台人工同步 |
