...
| [`change-cards/`](change-cards/) | SEO-IMP-024/035/036/037/038、SEO-V2-007/008/015、PCD-001/003/004/005/006 | 单一变量、基线、Crawl 和最终决策；PCD-001/003/004/006 已完成生产验收并进入 `measuring`；PCD-005 的范围文案风险缓解已通过生产验收，证书门户核验仍为 `deferred / external-input` |
