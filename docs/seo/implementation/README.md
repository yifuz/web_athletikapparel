...
| [`change-cards/`](change-cards/) | SEO-IMP-024/035/036/037/038、SEO-V2-004/005/007/008/015、PCD-001/003/004/005/006/007/008/009 | 单一变量、基线、Crawl 和最终决策；SEO-V2-004 首页视频 Hero 已完成延迟加载单变量实施，待生产三轮移动 Lab 与视觉验收；已部署项目按各自 Day 7 / 28 / 90 节点测量，外部凭据不足的项目继续 deferred |
