...
| [`change-cards/`](change-cards/) | SEO-IMP-024/035/036/037/038、SEO-V2-007/008 | 单一变量、基线、Crawl 和最终决策；V2-007 的 JPG 兼容修复已通过生产技术验收、待 LinkedIn 实际预览，V2-008 已完成生产验收并 `fixed / keep` |
