...
| SEO-V2-005 | 用非品牌 Query 扩充现有页面证据与内链 | IMP-014/022 | P1 | `ready-to-deploy` | 2026-09-01 所有者批准先优化 `/underwear-manufacturer/`；跨市场 SERP 支持 `performance underwear manufacturer` 的 B2B 页面所有权，生产页正文仅 237 words。低 GSC 样本不支持 Title / Meta 实验，因此只增强既有页面正文证据和 Tech Pack Guide 内链 | 保持 URL、Title、Meta、H1、图片与 Schema 类型不变；Day 0 完成生产 HTML、视觉和 Crawl 验收，Day 28 / 90 按同口径评估；不创建 Performance Underwear / Base Layer 近义页 |
