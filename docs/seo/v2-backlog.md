...
| SEO-V2-003 | 索引、Crawl 与 HTML 响应持续监测 | IMP-033/038 | P0 | `monitoring` | 2026-09-01 Services 单页只读复查仍为 `NEUTRAL / Discovered - currently not indexed`，相对 2026-08-28 为 unchanged、无 regression；生产 HTTP、robots、canonical、Sitemap 与首页发现入口均正常。此前实时测试已通过并请求编入索引一次 | 不重复提交或改页；按周度节奏复查 Services indexed snapshot，并继续周期 Crawl / Index Snapshot |
...
| SEO-V2-005 | 用非品牌 Query 扩充现有页面证据与内链 | IMP-014/022 | P1 | `implementation / measuring` | Underwear 已完成生产验收并进入 Day 28 / 90 测量。2026-09-01 三个低曝光品类复筛中，Sportswear 仅见不匹配品牌词、Sports Accessories 无可见 Query 行；Knitted Fabrics 出现 `functional knitted fabrics factory`（2 impressions / average position 37），US / GB / CA Live SERP 均为功能针织面料厂、开发、应用与测试意图。所有者批准在低样本下做一次受控正文澄清；本地仅明确 own fabric mill、in-house testing 与 approved specification，不改 URL、Title、Meta、H1、图片或 Schema 类型 | 部署并完成 Knitted Fabrics Day 0 验收后进入独立 Day 28 / 90 观察；不把 2 次曝光解释为趋势，不创建 Performance Fabrics 或其他近义页，不继续滚动改写其他低样本页面 |
