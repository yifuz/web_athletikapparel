...
| SEO-V2-016 | 首页 Merino / Knitted Fabrics 类目卡图片交付 | SEO-V2-004 三次移动 Lab 的重复 image delivery Finding | P1 | `implemented / deployment-pending` | 三轮报告重复点名约 782 KB 的 Merino 960w lossless 与约 285 KB 的 Knitted Fabrics 1200w q100；2026-09-19 已从同一源图生成两组 q80 的 480 / 640 / 960 / 原尺寸 WebP，并仅更新这两张首页卡片的 responsive candidates | 单独部署模板与 8 个 uploads 图片；生产验证 HTTP、实际候选、Desktop/Mobile 视觉、三次同条件移动 Lab 和 Crawl Diff。URL、文案、alt、链接、构图及其他五张卡片保持不变；按 Finding 结果决定 keep / iterate / revert |
