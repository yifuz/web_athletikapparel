...
| SEO-V2-007 | 品类页社交图 / Schema 主图 | IMP-013 | P1 | `production-accepted / share-preview-pending` | 2026-08-27 已完成部署和 7/7 生产验收：OG/Twitter/Schema 图一致，页面与图片均为 200，生产实际尺寸/MIME 与声明一致，JSON-LD 可解析且 Organization Logo 不变；同 URL 定向审计 7/7 fetched、0 failed、0 high/medium issue。仅登录态社交平台实际预览未取得可验证证据 | 在任一实际平台抽查无旧 Logo、取图失败或不可接受裁切后改为 `fixed / keep` |
