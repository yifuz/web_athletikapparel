...
| SEO-V2-006 | 站外行业引用与可信目录运营 | IMP-020 | P1 | `operational / owner-input` | 2026-08-27 公开索引仍只发现 ThomasNet 美国主体旧档，未发现已注册的中国主体 Profile URL；OEKO-TEX / WRAP 公开端也未取得可核实 Athletik 条目。下一步需要 ThomasNet Dashboard 状态或 URL、OEKO-TEX certificate / label number、WRAP ID / 有效期 / 公开列名状态 | 获得可核实公开 URL 并记录维护责任；不以链接总数作为成功指标 |
