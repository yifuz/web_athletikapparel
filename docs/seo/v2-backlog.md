...
| SEO-V2-005 | 用非品牌 Query 扩充现有页面证据与内链 | IMP-014/022 | P1 | `fixed / measuring` | Underwear 与 Knitted Fabrics 均已完成生产 Day 0 验收。Knitted Fabrics 的 own fabric mill、in-house testing、functional knits 与 approved specification 正文证据已生效；HTTP、索引信号、Title/Meta/H1、OG/Twitter、Schema、Sitemap、首页入口和 1440×900 / 390×844 渲染均通过。Sportswear 与 Sports Accessories 复筛保持 `no-change` | Underwear 与 Knitted Fabrics 分别进入 Day 28 / 90 同口径观察；Knitted Fabrics Day 7 为 2026-09-08、Day 28 为 2026-09-29、Day 90 为 2026-11-30。不把 2 次曝光解释为趋势，不创建 Performance Fabrics 或其他近义页，不继续滚动改写其他低样本页面 |
