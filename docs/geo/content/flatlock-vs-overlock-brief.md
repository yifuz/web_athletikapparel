...
## 1. Proposed page setup

| Item | Draft direction |
|---|---|
...
Complete only confirmed cells. Remove any row that cannot be supported.
...
Add answers only if they reflect real recurring questions and appear visibly on
the page. Potential questions:
...
- Link to `/contact/` once, after the technical content.
- Add original photographs or process video only after customer/confidentiality
  review.
