...
| GEO-V2-005 | 启用 Bing Webmaster Tools AI 引用观测 | 引用 | P1 | `capture-ready / owner-data-pending` | 已建立[采集单](testing/bing-ai-performance-baseline.md)，尚无后台数据；AI Performance 可用则据实建立首个快照，不可用则留存界面证据并记录原因 |
