# Flywheel 服务器 27G 清理操作指引（已完成 / 已归档）

> 生成时间：2026-07-24。
> 完成时间：2026-07-28。
> 状态：✅ 27GB 旧素材已从网站目录和 Flywheel 服务器移除；最终网站与
> 当前 uploads 已重新推送，Flywheel 总存储占用约 660MB。
>
> 本文以下内容仅作为故障处理历史记录。文中 2026-07-24 生成的 270MB
> ZIP 和“218 个文件 / 0.27G”均为旧快照，不可用于后续部署。
