...
`docs/sitemap.md` 和 `docs/seo/seo-process.md`。本文件用于规划推广、数据归因、询盘筛选
...
2026-08-07 更新：Instagram 付费推广（当前每日 RMB 68，计划范围 RMB 50–100/日）与 YouTube 自然运营
...
- Search Console、Sitemap、Canonical、H1、Meta Description 和 JSON-LD
  已完成首轮技术 SEO 整改；当前基线见 [`../seo/gsc-data-log.md`](../seo/gsc-data-log.md)
  与 [`../seo/seo-cli-baseline-2026-08-18.md`](../seo/seo-cli-baseline-2026-08-18.md)。
...
> 本节保留 2026-08-03 制定的推广启动顺序，用于解释基础设施、广告上线和
> Outbound 准备的先后关系，不再作为 2026-09-24 之后的当前执行日历。
> 当前跨渠道 Promotion 节点统一见 [`promotion-timeline.md`](promotion-timeline.md)；
> 该时间线不重复 SEO 或 GEO 的独立任务。
...
2026-08-07 补充：Instagram/Meta 计划范围为每日 RMB 50–100（约每月
RMB 1,500–3,000），当前实际设置为每日 RMB 68；该预算线单独运行，不计入上述
Google Search 阶梯框架，其预算调整依据
品牌指标与整体效果，渠道分工与调整规则见 `promotion-matrix.md` 第 1–2 节。
Google 与 Instagram 使用独立目标和扩量门槛。Meta 首次扩量只依据自身至少 7 天的
净增关注、广告关注成本、关注转化和真实账号比例；2026-08-07 核对的当前平台设置为
每日 RMB 68，首个 7 天观察期保持不变。
当前投放视频作为暂定对照素材，初始观察期内保持预算与素材稳定；历史素材不能只因主页
访问成本更低就恢复投放。先补齐同一窗口的净增关注、广告关注成本、真实账号比例和
可疑账号比例，再决定测试或扩量。买家和服装行业账号占比是次级战略指标，不要求每个
关注者都直接形成询盘。
