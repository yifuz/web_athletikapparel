...
- 公开事实必须来自已批准的一方资料；不得发明认证、产能、工厂数量、客户或实体关系。
...
当不同来源冲突时，先确认日期和用途，不直接选择更有利的说法。公开事实由所有者批准的当前资料优先；第三方数据库、历史网站和 AI 回答只能作为线索。
...
- 询盘是否符合 MOQ 1,000 pieces per style；
...
- 回答该意图下最重要的采购问题；
- 使用可验证的一方知识、图片、工艺和流程；
- 区分已确认事实、一般行业解释和需要用户决定的变量；
- 不复制竞争对手，不拼接通用资料，不制造虚假第一手经验；
...
- 新的 Title/H1/Meta 真值；
- 长篇公开正文；
- 认证、客户、产能、工厂、设备、材料性能和实体关系声明；
- 客户 Logo、案例、评价或合作关系；
- 新国家或语言版本；
- 付费外链、赞助内容或高风险目录；
- Privacy Policy 或法律相关页面的 SEO 文案。

技术审查、内部研究、数据汇总和不改变外部状态的诊断可以直接进行。
